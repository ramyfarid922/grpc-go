...
type SqrtRequest struct {
	...
	Number int32 `protobuf:"varint,1,opt,name=number,proto3" json:"number,omitempty"` // could be uint32 but we won't do that
}
...
var file_sqrt_proto_rawDesc = []byte{
	...
	0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x72, 0x61, 0x6d, 0x79, 0x66, 0x61, 0x72, 0x69, 0x64, 0x39,
	0x32, 0x32, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x2d, 0x67, 0x6f, 0x2f, 0x63, 0x61, 0x6c, 0x63, 0x75,
