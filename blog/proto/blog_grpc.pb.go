...
type BlogServiceClient interface {
	...
	// Notice that if the rpc returns stream of blogs, that doesn't mean that the rpc handler signature will return a stream
	// In fact the way it goes, the handler signature "takes a stream as an input" and then uses it to write back to its caller
